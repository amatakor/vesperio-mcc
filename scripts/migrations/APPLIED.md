...
| 2026-07-22 | `2026-07-22-ll2-aggregator.ts` | Reclassed Launch Library from `computed` to `aggregator` on 5 item sources (Florian's adjudication; CLAUDE.md and the registry path always scored LL2 as aggregator). The 3 LL2-led launch items rescored 5 to 4 under the direct-source ceiling; movement logged in the state.json sweep log. |
